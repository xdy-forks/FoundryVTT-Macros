...
async function applyChanges($html) {
  for (const token of canvas.tokens.controlled) {
    ...
    if (checkFeat("spell-stitcher") && useBattleMedicine) {
      if (token.actor.itemTypes.effect.some(obj => {
    ...
    for (let target of game.user.targets) {
      ...
      switch (usedProf) {
        ...
        case 1:
          rollTreatWounds({
            DC: 15 + mod,
            bonus: 0 + medicBonus + godlessHealingBonus + useBattleMedicineBonus + magicHandsBonus + robustHealthBonus,
            med,
            isRiskySurgery,
            useMortalHealing,
            useMagicHands,
        ...
        case 2:
          rollTreatWounds({
            DC: 20 + mod,
            bonus: 10 + medicBonus + godlessHealingBonus + useBattleMedicineBonus + magicHandsBonus + robustHealthBonus,
            med,
            isRiskySurgery,
            useMortalHealing,
            useMagicHands,
        ...
        case 3:
          rollTreatWounds({
            DC: 30 + mod,
            bonus: 30 + medicBonus + godlessHealingBonus + useBattleMedicineBonus + magicHandsBonus + robustHealthBonus,
            med,
            isRiskySurgery,
            useMortalHealing,
            useMagicHands,
        ...
        case 4:
          rollTreatWounds({
            DC: 40 + mod,
            bonus: 50 + medicBonus + godlessHealingBonus + useBattleMedicineBonus + magicHandsBonus + robustHealthBonus,
            med,
            isRiskySurgery,
            useMortalHealing,
            useMagicHands,
...
/* # source "https://gitlab.com/symonsch/my-foundryvtt-macros/-/tree/main/Contributions by others/Treat Wounds and Battle Medicine.js" - Fetched on 2024-09-28T20:42:09.450Z */
